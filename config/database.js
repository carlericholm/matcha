...
con.connect(function(err) {
  ...
  var sql = "CREATE TABLE IF NOT EXISTS visits (id INT PRIMARY KEY AUTO_INCREMENT, visited_id INT(6) UNSIGNED NOT NULL, visiter_id INT(6) UNSIGNED NOT NULL, date DATETIME)";
  con.query(sql, function (err, result) { if (err) throw err; console.log("Table visited created"); });
  var sql = "CREATE TABLE IF NOT EXISTS report (id INT PRIMARY KEY AUTO_INCREMENT, reported_id INT(6) UNSIGNED NOT NULL, reporter_id INT(6) UNSIGNED NOT NULL, date DATETIME)";
